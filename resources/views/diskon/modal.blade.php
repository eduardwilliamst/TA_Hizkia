            ...
            <div class="modal-body">
                <form action="{{ route('diskon.update', $diskon->id) }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="diskon_value" name="diskon_value" value="{{ $diskon->diskon_value }}" required>
                    </div>
                    <div class="form-group">
                        <label for="diskon_description">Diskon Description</label>
                        <input type="text" class="form-control" id="diskon_description" name="diskon_description" value="{{ $diskon->diskon_description }}" required>
                    </div>
